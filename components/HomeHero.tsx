...
export default function HomeHero() {
  ...
  return (
    <section className="relative min-h-[640px] md:h-[92vh] md:min-h-[620px] overflow-hidden -mt-16 md:-mt-20">
      {slides.map((s, i) => (
      ...
      <div className="relative h-full flex items-center pt-20 pb-16 md:pb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur text-white text-[10px] sm:text-xs font-semibold tracking-[0.14em] uppercase mb-5 md:mb-6 animate-fadeIn">
              <ShieldCheck className="w-3.5 h-3.5" /> ATOL Protected · Since 2015
            </span>

            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.05] animate-fadeIn delay-1">
              Your Sacred Journey,<br />
              <span className="text-brand-300">thoughtfully arranged.</span>
            </h1>

            <p className="mt-5 md:mt-6 text-sm sm:text-base md:text-lg text-white/85 max-w-2xl leading-relaxed animate-fadeIn delay-2">
            ...
            <div className="mt-7 md:mt-9 flex flex-wrap gap-3 animate-fadeIn delay-3">
              <Link href="/packages/umrah" className="btn-primary !px-6 !py-3 sm:!px-7 sm:!py-3.5 text-sm sm:text-base">
                Explore Umrah <ArrowRight className="w-4 h-4" />
              </Link>
              <Link href="/packages/hajj" className="inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 rounded-full bg-white/10 backdrop-blur border border-white/25 text-white font-semibold text-sm sm:text-base hover:bg-white/20 transition-all">
                View Hajj Packages
              </Link>
            </div>
          </div>
          ...
          <div className="mt-10 md:mt-16 lg:mt-24 animate-fadeIn delay-4">
            <div className="grid grid-cols-1 sm:inline-flex sm:flex-row sm:flex-wrap w-full sm:w-auto gap-y-3 gap-x-10 px-5 sm:px-6 py-4 rounded-2xl bg-white/10 backdrop-blur border border-white/15">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-base sm:text-lg font-semibold text-white leading-none">{s.val}</div>

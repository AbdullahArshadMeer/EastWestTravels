...
export const hajjPackages: Package[] = [
  {
    id: "hajj-2027-21-days",
    name: "21 Days Hajj Package 2027",
    category: "hajj",
    ...
    features: [
      ...
      "Maktab A — Premium tent in Mina (closest to Jamarat)",
    ...
    badge: "Maktab A — Premium Package",
    available: true,
    popular: true,
    description: "Our flagship 21-day Hajj package with premium 5-star accommodation at Anjum Hotel Madinah and Saja Hotel Makkah. Maktab A premium tent in Mina ensures the closest access to Jamarat. Designed for pilgrims who want comfort and proximity to Haram throughout their sacred journey.",
  ...
  {
    id: "hajj-2027-17-days",
    name: "17 Days Hajj Package 2027",
    category: "hajj",
    country: "Saudi Arabia",
    ...
    features: [
      ...
      "Visa processing",
      "All ground transfers",
      "Shorter trip — 17 days total",
    ],
    badge: "Maktab A — Premium Package",
    available: true,
    description: "A 17-day Hajj package with the same premium Anjum and Saja hotels as our 21-day option. Maktab A premium tent in Mina ensures the closest access to Jamarat. Ideal for pilgrims with limited time who don't want to compromise on hotel quality.",
  ...
  {
    id: "hajj-2027-15-days",
    name: "15 Days Hajj Package 2027",
    category: "hajj",
    country: "Saudi Arabia",
    ...
    badge: "Land Package · No Flights",
    available: true,
    description: "Our land-only 15-day Hajj package — perfect for pilgrims who prefer to arrange their own flights or are travelling from outside the UK. The package starts on arrival in Jeddah and includes all accommodation (Azizia, Maktab A in Mina, Saja Hotel Makkah), meals, transfers, and Hajj rituals. Flights are NOT included.",

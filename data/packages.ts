...
export const hajjPackages: Package[] = [
    ...
    maktabOptions: [
      {
        ...
        hotels: [
          { city: "Madinah", name: "Anjum Hotel", stars: 5, meal: "Full Board" },
          { city: "Azizia", name: "Azizia Apartments", stars: 4, meal: "Full Board" },
          { city: "Mina", name: "Maktab A — Premium Tent", stars: 5, meal: "Full Board" },
          { city: "Makkah", name: "Saja Hotel", stars: 5, meal: "Full Board" },
        ],
      },
      {
        label: "Maktab D Plus",
        ...
        hotels: [
          { city: "Madinah", name: "Anjum Hotel", stars: 5, meal: "Full Board" },
          { city: "Azizia", name: "Azizia Apartments", stars: 4, meal: "Full Board" },
          { city: "Mina", name: "Maktab D Plus Tent", stars: 4, meal: "Full Board" },
          { city: "Makkah", name: "Saja Hotel", stars: 5, meal: "Full Board" },
        ],
      },
    ],
...

  {
    ...
    maktabOptions: [
      {
        ...
        hotels: [
          { city: "Azizia", name: "Azizia Apartments", stars: 4, meal: "Full Board" },
          { city: "Mina", name: "Maktab A — Premium Tent", stars: 5, meal: "Full Board" },
          { city: "Makkah", name: "Swissotel Makkah", stars: 5, meal: "Full Board" },
          { city: "Madinah", name: "Mövenpick Madinah", stars: 5, meal: "Full Board" },
        ],
      },
      {
        label: "Maktab D Plus",
    ...
    available: true,
    popular: true,
    description: "The pinnacle of Hajj luxury — 21 days featuring our most prestigious 5-star hotels with stunning Haram views in Makkah and Madinah. Choose between Maktab A or Maktab D Plus tier in Mina. For pilgrims seeking the ultimate balance of luxury and devotion.",
...
export const umrahPackages: Package[] = [
  ...
  },
  {
    ...
    badge: "5-Star Package Upgrade Available", available: true,
    description: "Escape the UK winter with an 11-day Umrah journey during the December holidays. Fly from Birmingham to Jeddah with Saudia Airline, stay in 4-star hotels in both Makkah and Madinah, and enjoy   throughout. Guided Ziyarat tours in both holy cities and 24/7 group support included.",
  ...
  // ── EASTER / SPRING PACKAGE (Mar – Apr 2026) ──
  {
    ...
    badge: "5-Star Package Upgrade Available", available: true, popular: true,
    description: "Take advantage of the Easter school holidays for an 11-day Umrah trip. Fly from Birmingham with Saudi Airlines, stay in 4-star hotels near Haram, and enjoy  , full ground transport, and guided Ziyarat tours. Ideal for families wanting to combine school holidays with a spiritual journey.",

...
export const hajjPackages: Package[] = [
  {
    ...
    available: true,
    popular: true,
    description: "Our flagship 20-day Hajj package with premium 5-star accommodation in both Madinah and Makkah. Maktab A premium tent in Mina ensures the closest access to Jamarat. Designed for pilgrims who want comfort and proximity to Haram throughout their sacred journey.",
...

  {
    ...
    badge: "Maktab A — Premium Package",
    available: true,
    description: "A 16-day Hajj package with the same premium 5-star hotels as our 20-day option. Maktab A premium tent in Mina ensures the closest access to Jamarat. Ideal for pilgrims with limited time who don't want to compromise on hotel quality.",
...

  {
    ...
    badge: "Luxury · Maktab A Premium",
    available: true,
    popular: true,
    description: "The pinnacle of Hajj luxury — 21 days featuring Swissotel Makkah and Mövenpick Madinah, our most prestigious 5-star hotels with stunning Haram views. Maktab A premium tent in Mina ensures the closest access to Jamarat. For pilgrims seeking the ultimate balance of luxury and devotion.",

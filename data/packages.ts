...
export const hajjPackages: Package[] = [
  {
    ...
    features: [
      ...
      "Anjum Hotel Madinah & Saja Hotel Makkah",
    ...
    available: true,
    popular: true,
    description: "Our flagship 20-day Hajj package with premium 5-star accommodation at Anjum Hotel Madinah and Saja Hotel Makkah. Includes Maktab A (premium tent) for your Mina accommodation. Designed for pilgrims who want comfort and proximity to Haram throughout their sacred journey.",
...

  {
    ...
    available: true,
    description: "A 16-day Hajj package with the same premium Anjum and Saja hotels as our 20-day option, including Maktab A for Mina. Ideal for pilgrims with limited time who don't want to compromise on hotel quality.",
...

  {
    ...
    badge: "Land Package",
    available: true,
    description: "Our land-only 14-day Hajj package — perfect for pilgrims who prefer to arrange their own flights or are travelling from outside the UK. Includes Maktab A (premium tent) for Mina. Package starts on arrival in Jeddah and includes all accommodation (Azizia, Mina tent, Saja Hotel Makkah), meals, transfers, and Hajj rituals. Flights are NOT included.",
...
export const umrahPackages: Package[] = [
  ...
  // ── OCTOBER HALF TERM PACKAGES (Oct – Nov 2026) ──
  {
    ...
    dateRange: "20 Oct – 3 Nov 2026", airline: "Egypt Air", rating: 5, reviews: 584, startFrom: "£1,350",
    ...
    description: "Our longest October half term package — 14 days for a more relaxed, unhurried Umrah experience. Depart from Manchester with Egypt Air, enjoy 4-star hotels, and take advantage of the extended stay for deeper Ziyarat tours across both holy cities.",
    transport: "Return flights with Egypt Air from Manchester. Full ground transport package including airport transfers, inter-city travel, and Ziyarat coaches.",
  ...
  },
  {
    ...
    dateRange: "25 Oct – 3 Nov 2026", airline: "Egypt Air (Direct Flight)", rating: 5, reviews: 584, startFrom: "£1,395",
    ...
    badge: "5-Star Package Upgrade Available", available: true,
    description: "A compact 9-day Umrah during the October half term. Direct flights from Birmingham with Egypt Air, 4-star hotels near Haram, and a family-friendly itinerary designed to make the most of the school break.",
    transport: "Direct return flights with Egypt Air from Birmingham to Jeddah. All ground transport included — airport transfers and inter-city coaches.",
    ziyarahMakkah: ["Jabal al-Nour (Cave of Hira)", "Jabal Thawr", "Hudaibiyah"],
  ...
  // ── WINTER DECEMBER PACKAGES (Dec 2026) ──
  {
    ...
    dateRange: "15 Dec – 27 Dec 2026", airline: "Egypt Air", rating: 5, reviews: 584, startFrom: "£1,595",
    ...
    transport: "Return flights with Egypt Air. Private coaches for all ground transportation including airport transfers and inter-city travel between Makkah and Madinah.",
    ziyarahMakkah: ["Jabal al-Nour (Cave of Hira)", "Jabal Thawr", "Masjid al-Jinn", "Hudaibiyah"],
    ziyarahMadinah: ["Masjid al-Quba", "Masjid al-Qiblatayn", "Mount Uhud & Martyrs Cemetery", "Seven Mosques"],
  },
  {
    ...
    dateRange: "20 Dec – 31 Dec 2026", airline: "Egypt Air", rating: 5, reviews: 584, startFrom: "£1,750",
    ...
    badge: "5-Star Package Upgrade Available", available: true,
    description: "Escape the UK winter with an 11-day Umrah journey during the December holidays. Fly from Birmingham to Jeddah with Egypt Air, stay in 4-star hotels in both Makkah and Madinah. Guided Ziyarat tours in both holy cities and 24/7 group support included.",
    transport: "Return flights with Egypt Air from Birmingham. Private air-conditioned coaches for airport transfers, inter-city travel, and all Ziyarat tours.",
    ziyarahMakkah: ["Jabal al-Nour (Cave of Hira)", "Jabal Thawr", "Masjid al-Jinn", "Hudaibiyah"],
    ziyarahMadinah: ["Masjid al-Quba", "Masjid al-Qiblatayn", "Mount Uhud & Martyrs Cemetery", "Seven Mosques"],
  },
  ...
  // ── WINTER 2026/27 PACKAGES (Dec 2026 – Jan 2027) ──
  {
    ...
    badge: "5-Star Package Upgrade Available", available: true,
    description: "A 12-day winter Umrah departing from Manchester with an indirect EgyptAir flight, flying into Jeddah and Madinah. Stay at the Emaar Grand Hotel in Makkah with Bed & Breakfast and the Saja Al Madinah Hotel in Madinah on a Room Only basis. Limited 5-star upgrade seats available, with flexible payment plans.",
    transport: "Indirect return flights with EgyptAir from Manchester. All ground transfers between airport, Makkah, and Madinah included.",
    ziyarahMakkah: ["Jabal al-Nour (Cave of Hira)", "Jabal Thawr", "Hudaibiyah"],
    ziyarahMadinah: ["Masjid al-Quba", "Mount Uhud & Martyrs Cemetery", "Seven Mosques"],
  },
  {
    ...
    badge: "5-Star Package Upgrade Available", available: true,
    description: "A 12-day winter Umrah departing from Birmingham with an indirect EgyptAir flight, flying into Jeddah and Madinah. Stay at the Emaar Grand Hotel in Makkah with Bed & Breakfast and the Saja Al Madinah Hotel in Madinah on a Room Only basis. Limited 5-star upgrade seats available, with flexible payment plans.",
    transport: "Indirect return flights with EgyptAir from Birmingham. All ground transfers between airport, Makkah, and Madinah included.",
    ziyarahMakkah: ["Jabal al-Nour (Cave of Hira)", "Jabal Thawr", "Hudaibiyah"],
    ziyarahMadinah: ["Masjid al-Quba", "Mount Uhud & Martyrs Cemetery", "Seven Mosques"],
  },
];

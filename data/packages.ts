...
export const hajjPackages: Package[] = [
  {
    ...
    maktabOptions: [
      {
        ...
        hotels: [
          { city: "Makkah", name: "Anjum Hotel", stars: 5, meal: "Half Board" },
          { city: "Azizia", name: "Jawhara Maysan Hotel", stars: 4, meal: "Half Board" },
          { city: "Mina", name: "Maktab A — Premium Tent", stars: 5, meal: "Half Board" },
          { city: "Madinah", name: "Saja Al Madinah Hotel", stars: 5, meal: "Half Board" },
        ],
      },
      {
        label: "Maktab C",
        ...
        sharingOptions: [
          { label: "Quad Sharing", price: "£7,350" },
          { label: "Triple Sharing", price: "£7,650" },
          { label: "Double Sharing", price: "£7,950" },
        ],
        hotels: [
          { city: "Makkah", name: "Anjum Hotel", stars: 5, meal: "Half Board" },
          { city: "Azizia", name: "Jawhara Maysan Hotel", stars: 4, meal: "Half Board" },
          { city: "Mina", name: "Maktab C — Standard Tent", stars: 4, meal: "Half Board" },
          { city: "Madinah", name: "Saja Al Madinah Hotel", stars: 5, meal: "Half Board" },
        ],
      },
    ],
    features: [
      ...
      "Choice of Maktab A or Maktab C",
      "Anjum Hotel Makkah & Saja Hotel Madinah",
    ...
    badge: "Maktab A & C Options",
    available: true,
    popular: true,
    description: "Our flagship 20-day Hajj package with premium 5-star accommodation at Anjum Hotel Madinah and Saja Hotel Makkah. Choose between Maktab A (premium tent) or Maktab C (excellent value) for your Mina accommodation. Designed for pilgrims who want comfort and proximity to Haram throughout their sacred journey.",
    ...
    itinerary: [
      ...
      { date: "20–23 May", location: "Saja Al Madinah Hotel, Madinah" },
    ],
...

  {
    ...
    maktabOptions: [
      {
        ...
        hotels: [
          { city: "Makkah", name: "Anjum Hotel", stars: 5, meal: "Half Board" },
          { city: "Azizia", name: "Jawhara Maysan Hotel(Azizia)", stars: 4, meal: "Half Board" },
          { city: "Mina", name: "Maktab A — Premium Tent", stars: 5, meal: "Half Board" },
          { city: "Madinah", name: "Saja al Madinah Hotel", stars: 5, meal: "Half Board" },
        ],
      },
      {
        ...
        description: "Standard tent in Mina — excellent value",
        sharingOptions: [
          { label: "Quad Sharing", price: "£6,995" },
          { label: "Triple Sharing", price: "£7,245" },
          { label: "Double Sharing", price: "£7,495" },
        ],
        hotels: [
          { city: "Makkah", name: "Anjum Hotel", stars: 5, meal: "Half Board" },
          { city: "Azizia", name: "Jawhara Maysan Hotel(Azizia)", stars: 4, meal: "Half Board" },
          { city: "Mina", name: "Maktab C — Standard Tent", stars: 4, meal: "Half Board" },
          { city: "Madinah", name: "Saja Hotel", stars: 5, meal: "Half Board" },
        ],
      },
    ],
    features: [
    ...
    badge: "Maktab A & C Options",
    available: true,
    description: "A 16-day Hajj package with the same premium Anjum and Saja hotels as our 20-day option. Choose between Maktab A or Maktab C for Mina. Ideal for pilgrims with limited time who don't want to compromise on hotel quality.",
...

  {
    ...
    maktabOptions: [
      ...
      },
      {
        ...
        description: "Standard tent in Mina — excellent value",
        sharingOptions: [
          { label: "Quad Sharing", price: "£5,500" },
          { label: "Triple Sharing", price: "£5,950" },
          { label: "Double Sharing", price: "£6,400" },
        ],
        hotels: [
          { city: "Azizia", name: "Jawhara Maysan Hotel(Azizia)", stars: 4, meal: "Half Board" },
          { city: "Mina", name: "Maktab C — Premium Tent", stars: 5, meal: "Half Board" },
          { city: "Madinah", name: "Saja Al MAdinah Hotel", stars: 5, meal: "Half Board" },
        ],
      },
    ],
    ...
    badge: "Land Package · Maktab A & C Options",
    available: true,
    description: "Our land-only 14-day Hajj package — perfect for pilgrims who prefer to arrange their own flights or are travelling from outside the UK. Choose between Maktab A (premium tent) or Maktab C (excellent value) for Mina. Package starts on arrival in Jeddah and includes all accommodation (Azizia, Mina tent, Saja Hotel Makkah), meals, transfers, and Hajj rituals. Flights are NOT included.",
